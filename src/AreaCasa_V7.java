 ...
 * Programa com o uso de Métodos,Parâmetros,Atributos,Condicionais Aninhados,operador '?' é Switch.
 * @version 8
 * @author Ilem Santos
 */
public class AreaCasa_V7 {
    ...
    */
    ...
    public static void main(String[] args){
        ...
        System.out.println(valorPiscina(100,1));
